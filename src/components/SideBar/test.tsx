...
describe("<SideBar />", () => {
	it("should render SideBar component with github and linkedin profile and default values for sizes", () => {
		...
		expect(
			screen.getByLabelText("vertical division line")
		).toBeInTheDocument();
	});
	...
	it("should not render SideBar with github profile ", () => {
		renderTheme(
			<SideBar githubURL="tício" linkedinURL={mock.linkedinURL} />
		);
		...
		).toHaveAttribute("href", mock.linkedinURL);
		expect(
			screen.getByLabelText("vertical division line")
		).toBeInTheDocument();
	});
	...
	it("should not render SideBar", () => {
		...
		expect(
			screen.queryByLabelText("vertical division line")
		).not.toBeInTheDocument();
	});
